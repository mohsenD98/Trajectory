...
class Cluster:
    def __init__(self) -> None:
        ...
        self.colorList = ['purple','red','blue', 'green', 'yellow', 'orange', 'cyan', 'teal']
    ...
    def _calcDBSCAN(self):  
            ...
            dbscan_opt=DBSCAN(eps=1,min_samples=1)
    ...
    def plot(self):
        ...
        plt.scatter(self.data[0],self.data[1],c=self.data[plotTitle+'_labels'],cmap=matplotlib.colors.ListedColormap(self.colorList),s=15)
